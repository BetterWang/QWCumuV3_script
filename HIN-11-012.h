...
void HIN_11_012() {
	...
	grHIN_v2pt_sys[0]->SetPointError(0,   0,   0.00154);
	grHIN_v2pt_sys[0]->SetPointError(1,   0,   0.00164);
	grHIN_v2pt_sys[0]->SetPointError(2,   0,   0.00179);
	grHIN_v2pt_sys[0]->SetPointError(3,   0,   0.00199);
	grHIN_v2pt_sys[0]->SetPointError(4,   0,   0.00217);
	grHIN_v2pt_sys[0]->SetPointError(5,   0,   0.00235);
	grHIN_v2pt_sys[0]->SetPointError(6,   0,   0.00249);
	grHIN_v2pt_sys[0]->SetPointError(7,   0,   0.00266);
	grHIN_v2pt_sys[0]->SetPointError(8,   0,   0.00286);
	grHIN_v2pt_sys[0]->SetPointError(9,   0,   0.00301);
	grHIN_v2pt_sys[0]->SetPointError(10,  0,   0.00277);
	grHIN_v2pt_sys[0]->SetPointError(11,  0,   0.00234);
	grHIN_v2pt_sys[0]->SetPointError(12,  0,   0.00184);
	grHIN_v2pt_sys[0]->SetPointError(13,  0,   0.00159);
	grHIN_v2pt_sys[0]->SetPointError(14,  0,   0.00152);
	grHIN_v2pt_sys[0]->SetPointError(15,  0,   0.00137);
	grHIN_v2pt_sys[0]->SetPointError(16,  0,   0.00102);
	grHIN_v2pt_sys[0]->SetPointError(17,  0,   0.00089);
	grHIN_v2pt_sys[0]->SetPointError(18,  0,   0.00075);
	grHIN_v2pt_sys[0]->SetPointError(19,  0,   0.00084);
	grHIN_v2pt_sys[0]->SetPointError(20,  0,   0.00079);
	grHIN_v2pt_sys[0]->SetPointError(21,  0,   0.00061);
	grHIN_v2pt_sys[0]->SetPointError(22,  0,   0.00060);
	grHIN_v2pt_sys[0]->SetPointError(23,  0,   0.00110);
	...
	grHIN_v2pt_sys[1]->SetPointError(0,   0,   0.00290);
	grHIN_v2pt_sys[1]->SetPointError(1,   0,   0.00311);
	grHIN_v2pt_sys[1]->SetPointError(2,   0,   0.00339);
	grHIN_v2pt_sys[1]->SetPointError(3,   0,   0.00376);
	grHIN_v2pt_sys[1]->SetPointError(4,   0,   0.00409);
	grHIN_v2pt_sys[1]->SetPointError(5,   0,   0.00440);
	grHIN_v2pt_sys[1]->SetPointError(6,   0,   0.00469);
	grHIN_v2pt_sys[1]->SetPointError(7,   0,   0.00495);
	grHIN_v2pt_sys[1]->SetPointError(8,   0,   0.00532);
	grHIN_v2pt_sys[1]->SetPointError(9,   0,   0.00552);
	grHIN_v2pt_sys[1]->SetPointError(10,  0,   0.00504);
	grHIN_v2pt_sys[1]->SetPointError(11,  0,   0.00424);
	grHIN_v2pt_sys[1]->SetPointError(12,  0,   0.00352);
	grHIN_v2pt_sys[1]->SetPointError(13,  0,   0.00294);
	grHIN_v2pt_sys[1]->SetPointError(14,  0,   0.00247);
	grHIN_v2pt_sys[1]->SetPointError(15,  0,   0.00199);
	grHIN_v2pt_sys[1]->SetPointError(16,  0,   0.00174);
	grHIN_v2pt_sys[1]->SetPointError(17,  0,   0.00161);
	grHIN_v2pt_sys[1]->SetPointError(18,  0,   0.00141);
	grHIN_v2pt_sys[1]->SetPointError(19,  0,   0.00127);
	grHIN_v2pt_sys[1]->SetPointError(20,  0,   0.00109);
	grHIN_v2pt_sys[1]->SetPointError(21,  0,   0.00123);
	grHIN_v2pt_sys[1]->SetPointError(22,  0,   0.00098);
	grHIN_v2pt_sys[1]->SetPointError(23,  0,   0.00030);
	...
	grHIN_v2pt_sys[2]->SetPointError(0,   0,   0.00383);
	grHIN_v2pt_sys[2]->SetPointError(1,   0,   0.00411);
	grHIN_v2pt_sys[2]->SetPointError(2,   0,   0.00448);
	grHIN_v2pt_sys[2]->SetPointError(3,   0,   0.00495);
	grHIN_v2pt_sys[2]->SetPointError(4,   0,   0.00535);
	grHIN_v2pt_sys[2]->SetPointError(5,   0,   0.00575);
	grHIN_v2pt_sys[2]->SetPointError(6,   0,   0.00609);
	grHIN_v2pt_sys[2]->SetPointError(7,   0,   0.00637);
	grHIN_v2pt_sys[2]->SetPointError(8,   0,   0.00673);
	grHIN_v2pt_sys[2]->SetPointError(9,   0,   0.00679);
	grHIN_v2pt_sys[2]->SetPointError(10,  0,   0.0061 );
	grHIN_v2pt_sys[2]->SetPointError(11,  0,   0.00517);
	grHIN_v2pt_sys[2]->SetPointError(12,  0,   0.00427);
	grHIN_v2pt_sys[2]->SetPointError(13,  0,   0.00376);
	grHIN_v2pt_sys[2]->SetPointError(14,  0,   0.00326);
	grHIN_v2pt_sys[2]->SetPointError(15,  0,   0.00229);
	grHIN_v2pt_sys[2]->SetPointError(16,  0,   0.00209);
	grHIN_v2pt_sys[2]->SetPointError(17,  0,   0.00208);
	grHIN_v2pt_sys[2]->SetPointError(18,  0,   0.00198);
	grHIN_v2pt_sys[2]->SetPointError(19,  0,   0.00159);
	grHIN_v2pt_sys[2]->SetPointError(20,  0,   0.00149);
	grHIN_v2pt_sys[2]->SetPointError(21,  0,   0.00101);
	grHIN_v2pt_sys[2]->SetPointError(22,  0,   0.00070);
	grHIN_v2pt_sys[2]->SetPointError(23,  0,   0.00140);
	...
	grHIN_v2pt_sys[3]->SetPointError(0,   0,  0.00447);
	grHIN_v2pt_sys[3]->SetPointError(1,   0,  0.00478);
	grHIN_v2pt_sys[3]->SetPointError(2,   0,  0.00519);
	grHIN_v2pt_sys[3]->SetPointError(3,   0,  0.00569);
	grHIN_v2pt_sys[3]->SetPointError(4,   0,  0.00616);
	grHIN_v2pt_sys[3]->SetPointError(5,   0,  0.00655);
	grHIN_v2pt_sys[3]->SetPointError(6,   0,  0.00688);
	grHIN_v2pt_sys[3]->SetPointError(7,   0,  0.00716);
	grHIN_v2pt_sys[3]->SetPointError(8,   0,  0.00744);
	grHIN_v2pt_sys[3]->SetPointError(9,   0,  0.00725);
	grHIN_v2pt_sys[3]->SetPointError(10,  0,  0.00643);
	grHIN_v2pt_sys[3]->SetPointError(11,  0,  0.00556);
	grHIN_v2pt_sys[3]->SetPointError(12,  0,  0.00451);
	grHIN_v2pt_sys[3]->SetPointError(13,  0,  0.00402);
	grHIN_v2pt_sys[3]->SetPointError(14,  0,  0.00336);
	grHIN_v2pt_sys[3]->SetPointError(15,  0,  0.00262);
	grHIN_v2pt_sys[3]->SetPointError(16,  0,  0.00239);
	grHIN_v2pt_sys[3]->SetPointError(17,  0,  0.00228);
	grHIN_v2pt_sys[3]->SetPointError(18,  0,  0.002	);
	grHIN_v2pt_sys[3]->SetPointError(19,  0,  0.0017);
	grHIN_v2pt_sys[3]->SetPointError(20,  0,  0.00166);
	grHIN_v2pt_sys[3]->SetPointError(21,  0,  0.00134);
	grHIN_v2pt_sys[3]->SetPointError(22,  0,  0.00069);
	grHIN_v2pt_sys[3]->SetPointError(23,  0,  0.0001);
	...
	grHIN_v2pt_sys[4]->SetPointError(0,   0,     0.0050 );
	grHIN_v2pt_sys[4]->SetPointError(1,   0,     0.0053 );
	grHIN_v2pt_sys[4]->SetPointError(2,   0,     0.0058 );
	grHIN_v2pt_sys[4]->SetPointError(3,   0,     0.0063 );
	grHIN_v2pt_sys[4]->SetPointError(4,   0,     0.0067 );
	grHIN_v2pt_sys[4]->SetPointError(5,   0,     0.0071 );
	grHIN_v2pt_sys[4]->SetPointError(6,   0,     0.0074 );
	grHIN_v2pt_sys[4]->SetPointError(7,   0,     0.0076 );
	grHIN_v2pt_sys[4]->SetPointError(8,   0,     0.0078 );
	grHIN_v2pt_sys[4]->SetPointError(9,   0,     0.0075 );
	grHIN_v2pt_sys[4]->SetPointError(10,  0,     0.0066 );
	grHIN_v2pt_sys[4]->SetPointError(11,  0,     0.0056 );
	grHIN_v2pt_sys[4]->SetPointError(12,  0,     0.0048 );
	grHIN_v2pt_sys[4]->SetPointError(13,  0,     0.0045 );
	grHIN_v2pt_sys[4]->SetPointError(14,  0,     0.0036 );
	grHIN_v2pt_sys[4]->SetPointError(15,  0,     0.00254);
	grHIN_v2pt_sys[4]->SetPointError(16,  0,     0.00258);
	grHIN_v2pt_sys[4]->SetPointError(17,  0,     0.00246);
	grHIN_v2pt_sys[4]->SetPointError(18,  0,     0.00200);
	grHIN_v2pt_sys[4]->SetPointError(19,  0,     0.00205);
	grHIN_v2pt_sys[4]->SetPointError(20,  0,     0.00134);
	grHIN_v2pt_sys[4]->SetPointError(21,  0,     0.00149);
	grHIN_v2pt_sys[4]->SetPointError(22,  0,     0.0032 );
	grHIN_v2pt_sys[4]->SetPointError(23,  0,     0.0009 );
	...
	grHIN_v2pt_sys[5]->SetPointError(0,   0,    0.0050  );
	grHIN_v2pt_sys[5]->SetPointError(1,   0,    0.0054  );
	grHIN_v2pt_sys[5]->SetPointError(2,   0,    0.0058  );
	grHIN_v2pt_sys[5]->SetPointError(3,   0,    0.0063  );
	grHIN_v2pt_sys[5]->SetPointError(4,   0,    0.0067  );
	grHIN_v2pt_sys[5]->SetPointError(5,   0,    0.0070  );
	grHIN_v2pt_sys[5]->SetPointError(6,   0,    0.0073  );
	grHIN_v2pt_sys[5]->SetPointError(7,   0,    0.0073  );
	grHIN_v2pt_sys[5]->SetPointError(8,   0,    0.0074  );
	grHIN_v2pt_sys[5]->SetPointError(9,   0,    0.0069  );
	grHIN_v2pt_sys[5]->SetPointError(10,  0,    0.0060  );
	grHIN_v2pt_sys[5]->SetPointError(11,  0,    0.0053  );
	grHIN_v2pt_sys[5]->SetPointError(12,  0,    0.0048  );
	grHIN_v2pt_sys[5]->SetPointError(13,  0,    0.0042  );
	grHIN_v2pt_sys[5]->SetPointError(14,  0,    0.0036  );
	grHIN_v2pt_sys[5]->SetPointError(15,  0,    0.0033  );
	grHIN_v2pt_sys[5]->SetPointError(16,  0,    0.00245 );
	grHIN_v2pt_sys[5]->SetPointError(17,  0,    0.00257 );
	grHIN_v2pt_sys[5]->SetPointError(18,  0,    0.00221 );
	grHIN_v2pt_sys[5]->SetPointError(19,  0,    0.00214 );
	grHIN_v2pt_sys[5]->SetPointError(20,  0,    0.0023  );
	grHIN_v2pt_sys[5]->SetPointError(21,  0,    0.0016  );
	grHIN_v2pt_sys[5]->SetPointError(22,  0,    0.0074  );
	grHIN_v2pt_sys[5]->SetPointError(23,  0,    0.0048  );
